    ...
    <>
      ...
      <div className="join-us-main-section">
        <div className="main-section-wrapper">
            <div className="main-section-title"><h1>Join Us</h1></div>
            <div className="main-section-image-container">
                <img src="" alt="" />
            </div>
        </div>
      </div>
      <div className="join-us-ministry-section"></div>
      <div className="join-us-volunteer-section"></div>
      <div className="join-us-connect-group"></div>
